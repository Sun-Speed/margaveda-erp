...
export default function LoginPage() {
  ...
  const features = [
    {
      ...
      desc: "Immutable, secure academic credentials.",
    },
    {
      title: "AI Career Paths",
      desc: "Intelligent roadmap for every student.",
    },
    {
      title: "Cloud-Native ERP",
      desc: "Manage institutions with modern speed.",
    },
  ];
  ...
  async function submit(e) {
    ...
    try {
      ...
      if (response.organizationCount > 1) {
        // Multiple Institutions → Group Dashboard
        navigate("/app/dashboard", {
          replace: true,
        });
      } else {
        // Single Institution → Institution Dashboard
        navigate(`/institution/${response.currentOrganization._id}/dashboard`, {
          replace: true,
        });
      }
    } catch (error) {
      ...
      <div className="hidden md:flex flex-1 flex-col justify-center px-20 z-10">
        ...
        >
          ...
          <p className="mt-8 text-xl text-gray-400 max-w-md">
            The next generation of institutional management. Secure,
            decentralized, and built for the future of learning.
          </p>
